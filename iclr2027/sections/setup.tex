...
24{,}576 rollouts across all reported experiments (incl.\ 7{,}680 pilot, 7{,}680 H-C, 9{,}216 H3) with per-row git commit, config hash, seeds, GPU model, and vLLM/torch versions; all failures logged as-is; no rollout fabricated or fabricable (Section~\ref{app:repro}).
