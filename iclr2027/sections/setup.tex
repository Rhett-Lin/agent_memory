...
16{,}896 rollouts across all reported experiments with per-row git commit, config hash, seeds, GPU model, and vLLM/torch versions; all failures logged as-is; no rollout fabricated or fabricable (Section~\ref{app:repro}).
